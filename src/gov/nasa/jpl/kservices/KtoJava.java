...
public class KtoJava {
    ...
    Model model;
    ArrayList<Model> packageModels = new ArrayList<Model>();
    ...
    private boolean smtSolved = false;
    ...
    public KtoJava( String k, String pkgName, boolean translate, boolean processStdoutAndStderr ) {
        ...
        // TODO -- FIXME -- This will break for same named classes in different scopes.
        // TODO -- FIXME -- Need to take into account packages and maybe enclosing classes.
...
////                System.out.println(z3Model.toString());
    ...
    public static Set< EntityDecl > getAllClasses(Model model) {
        Deque< EntityDecl > entitiesToGo =
                new ArrayDeque< EntityDecl >( getTopLevelClasses( model ) );
...
//    }
    ...
    public void translateClasses() {
        translateClasses(this.packageName);
    ...
    public void translateClasses(PackageDecl p) {
        if (p != null) {
            model = p.model();
            translateClasses( p.name().toString() );
        }
    }
    public void translateClasses(String packageName) {
...
//    }
    ...
    public void writeFiles( String directory ) {
        writeFiles(this, directory );
    }
    public static void writeFiles( KtoJava translator, String directory ) {
        if ( translator == null ) {
            return;
        }
    ...
    public void compileLoadAndRun() {
        ...
        EventXmlToJava.compileLoadAndRun(projectPath, this.packageName,
